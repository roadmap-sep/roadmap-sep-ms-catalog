...
import sh.roadmap.sep.catalog.infrastructure.output.jpa.adapter.CategoryJpaAdapter;
import sh.roadmap.sep.catalog.infrastructure.output.jpa.adapter.ProductJpaAdapter;
